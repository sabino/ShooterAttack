...
namespace ShooterAttack
{
    class WeaponManager
    {
        ...
        public static void FireWeapon(Vector2 location, Vector2 velocity)
        {
            switch (CurrentWeaponType)
            {
                case WeaponType.Normal:
                    ...
                    Sound.Shot.Play(0.5f, rand.NextFloat(-0.2f, 0.2f), 0);
                    break;
                ...
                case WeaponType.Rocket:
                    ...
                    Sound.Shot.Play(1.0f, rand.NextFloat(-0.2f, 0.2f), 0);
        ...
        private static void tryToSpawnPowerup(int x, int y, WeaponType type)
        {
            ...
            Rectangle thisDestination = Map.SquareWorldRectangle(new Vector2(x, y));
        ...
        private static void checkPowerupSpawns(float elapsed)
        {
            ...
            if (timeSinceLastPowerup >= timeBetweenPowerups)
            {
                ...
                tryToSpawnPowerup(rand.Next(0, Map.MapWidth), rand.Next(0, Map.MapHeight), type);
            }
        }
